...
public class TemperatureSubscriber implements ConfigurableComponent, CloudConnectionListener, CloudSubscriberListener {
	...
	//Set and Unset subscriber methods
	...
	//Activation API
	protected void activate(ComponentContext componentContext, Map<String, Object> properties) throws KuraClosedDeviceException {
